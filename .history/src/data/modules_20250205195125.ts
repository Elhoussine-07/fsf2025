    ...
    S1: [
      {
        code: 'M111',
        name: 'Analyse 1',
        details: [{name:'cours',Link:'https://drive.google.com/drive/folders/1-T2Z1bF8G27-HONiNPkOxal8tPFGm7-e?usp=drive_link'},{name:"TDs",Link:'#'}],
      ...
      },
      {
        code: 'M114',
        name: 'Mécanique 1',
        details: [{name:'Mécanique du point matériel'},
          { name: 'Cours', Link: '#'},
           { name: 'TDs',Link: '#'},],
      ...
      },
      {
        code: 'M115',
        name: 'Informatique 1',
        details: [{name:'Algorithmique et programmation'},
          { name: 'Cours', Link: '#'},
          { name: 'TDs',Link: '#'},],
      ...
      },
      {
        ...
        details: [{name:'Langue Anglaise'},{ name: 'Cours', Link: '#'},
          { name: 'TDs',Link: '#'},
