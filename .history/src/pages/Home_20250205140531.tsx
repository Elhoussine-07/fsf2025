...
export function StatsSection() {
  // Simule des données qui pourraient venir d'une API
  const stats = [
    { icon: <Book className="h-12 w-12 text-blue-400" />, value: 28, label: "Modules Total" },
    { icon: <Users className="h-12 w-12 text-blue-400" />, value: "500+", label: "Étudiants Actifs" },
    { icon: <GraduationCap className="h-12 w-12 text-blue-400" />, value: 4, label: "Semestres" },
  ];
